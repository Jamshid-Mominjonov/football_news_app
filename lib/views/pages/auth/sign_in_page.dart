...
import '../../../viewModels/auth/manager/sign_in/sign_in_state.dart';
...
class _SignInPageState extends ConsumerState<SignInPage> {
  ...
  void signIn({required SignInModel signInModel}) {
    ref.read(signInNotifierProvider.notifier).signIn(signInModel: signInModel);
  }
  @override
